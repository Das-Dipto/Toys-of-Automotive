        ...
        <form onSubmit={handleSubmit} className="w-full max-w-lg">
              <div className="flex flex-wrap mx-0 mb-6">
                <div className="w-full md:w-2/5 me-3 mb-6 md:mb-0">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-toy-name" name="toyName" type="text" placeholder="Toy name"/>
                ...
                <div className="w-full md:w-2/5 px-0">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-seller-name" name="sellerName" type="text" placeholder="Seller name"/>
                </div>
              </div>
              <div className="flex flex-wrap mx-0 mb-6">
                <div className="w-full md:w-2/5 md:me-3 px-0">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-seller-email" type="email" name='email' placeholder="Seller Email"/>
                </div>
                <div className="w-full md:w-2/5 me-3 px-0 mb-6 md:mb-0">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-picture" name="picture" type="text" placeholder="Toy Picture URL"/>
                </div>
              </div>
              ...
              <div className="w-full md:w-2/5 md:me-3 px-0 mb-6 md:mb-0">
                  ...
                  <div className="relative">
                    <select className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-subCategory" name="subCategory">
                ...
                <div className="w-full md:w-2/5 md:me-3 px-0 mb-6 md:mb-0">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-price" type="text" name="price" placeholder="Price"/>
                </div>
                <div className="w-full md:w-2/5 md:me-3  px-0 mb-6 md:mb-0 mt-8">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-rating" type="text" name="rating" placeholder="Rating"/>
                </div>
                <div className="w-full md:w-2/5 px-0 mb-6 md:mb-0 mt-8">
                  ...
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-quantity" type="text" name="quantity" placeholder="Quantity"/>
                </div>
              </div>
              <div className="w-full px-0 mb-6 md:mb-0 mt-8">
                  ...
                  <textarea id="grid-description" className=' w-full md:w-3/4 textarea textarea-bordered bg-gray-200' name="description" placeholder="Description"  rows='3' ></textarea>
                </div>
