    ...
    <footer aria-label="Site Footer" className="bg-gray-900">
      ...
      >
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="">
               <Link to='/' className="text-5xl flex items-center special-color" title='Toys of Automotive'>
                  <img src={MainLogo} className='w-[130px]' alt="logo" />    
                  <h2 className='text-teal-300 font-semibold'>ToTo</h2>
               </Link>
            </div>
